    ...
    public class AppDbInitializer
    {
        public static void Seed(IApplicationBuilder applicationBuilder)
        {
            using (var serviceScope = applicationBuilder.ApplicationServices.CreateScope())
            {
                ...
                {
                    context.Genres.AddRange(new Genre() { Name = "Шутер" });
                    context.Genres.AddRange(new Genre() { Name = "Стратегія" });
                    context.Genres.AddRange(new Genre() { Name = "MMORPG" });
                    context.Genres.AddRange(new Genre() { Name = "BattleRoyale" });
                    context.Genres.AddRange(new Genre() { Name = "Шутер" });
                    context.SaveChanges();
